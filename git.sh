...
gh pr create --base main --head "$BRANCH" --title "Automated GTFS dataset update ($BRANCH)" --body "Automated PR to merge regenerated GTFS dataset from branch \`$BRANCH\` into main." --repo "$REPO"
